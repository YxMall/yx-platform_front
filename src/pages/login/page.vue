      ...
      <div class="page-login--content"
        ...
        <div class="page-login--content-footer">
          ...
          <p class="page-login--content-footer-copyright">
            Copyright
            <d2-icon name="copyright" /> 2018 一笑商城 <a href="https://github.com/FairyEver">@smallJop</a>
          </p>
        </div>
      </div>
    </div>
...
<script>
import { getSinglePoetry } from '@/api/sys/login';
